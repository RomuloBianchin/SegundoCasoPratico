...
public class ClassTsf extends AppCompatActivity {

    // Declrando as váriavies.
    ListView meuLeitordeFeeds; // Objeto do tipo ListView, o mesmo irá receber a lista de noticías - Rss
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Adicionando o icone da aplicação em todas as actionBars.
        getSupportActionBar().setDisplayShowHomeEnabled(true);
        getSupportActionBar().setIcon(R.drawable.logo_app);

        // Instanciando o objeto do tipo ListView e associando o mesmo com o seu correspondente layout.
        meuLeitordeFeeds = (ListView) findViewById(R.id.listaDeFeeds);

        // Instanciando as variáveis do tipo ArrayList<String>
        titles = new ArrayList<String>();
        links = new ArrayList<String>();

        // Esse método será responsável pela ação que irá ocorrer em cada vez que clicarmos em um item da lista dos feeds.
    ...
    // Classe que irá realizar em background o processamento e análise do URL, XML e suas Tags,
    // já que não é permitido realizar esse tipo de ação na Mainthread./
    public class ProcessInBackground extends AsyncTask<Integer, Void, String>
    {
        //
        ProgressDialog progressDialog = new ProgressDialog(ClassTsf.this);
        ...
        */
        ...
        protected String doInBackground(Integer... integers) {
            try{
                URL url = new URL("http://feeds.tsf.pt/TSF-Ultimas"/*"https://rss.nytimes.com/services/xml/rss/nyt/World.xml"*/); // Passando o caminho do Feed.
        ...
        protected void onPostExecute(String s) {
            ...
            ArrayAdapter<String> adapter = new ArrayAdapter<String>(ClassTsf.this,R.layout.custom_layout_list_view, titles);
