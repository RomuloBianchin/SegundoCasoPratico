...
public class ClassPublicoPt extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.layout_publico);
    ...
    public InputStream getInputStream(URL url)
    {
        ...
        {
            Log.d("Erro ao conectar", "Web Site não é válido ou link incorreto"); /* Utilizamos o método Log.d para exibir no logCat uma
    ...
    {
        //
        ProgressDialog progressDialog = new ProgressDialog(ClassPublicoPt.this);
        ...
        */
        ...
        protected String doInBackground(Integer... integers) {
            try{
                URL url = new URL("https://feeds.feedburner.com/PublicoRSS"); // Passando o caminho do Feed.
                ...
                xmlPullParser.setInput(getInputStream(url), "UTF_8"); // Informando que o encoding do XML es UTF-8.
        ...
        protected void onPostExecute(String s) {
            ...
            ArrayAdapter<String> adapter = new ArrayAdapter<String>(ClassPublicoPt.this,R.layout.custom_layout_list_view, titles);
